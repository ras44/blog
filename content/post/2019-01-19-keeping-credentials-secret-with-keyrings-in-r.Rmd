...
So how can you provide credentials without putting them in the script itself?  There are a variety of options described in RStudio's ["Databases using R"](https://db.rstudio.com/best-practices/managing-credentials/).
